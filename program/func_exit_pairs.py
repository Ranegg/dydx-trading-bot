...
def manage_trade_exits(client):
    ...
    all_exchange_pos = exchange_pos.data["positions"]
    markets_live = []
    for p in all_exchange_pos:
    ...
    for position in open_positions_dict:
        ...
        if is_close:
            ...
            accept_price_m2 = price_m2 * 2.05 if side_m2 == "BUY" else price_m2 * 0.95
